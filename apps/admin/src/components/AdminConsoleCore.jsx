...
const LazyAdminConsoleDeferredFeatures = dynamic(() => import("./AdminConsoleDeferredFeatures"));
const LazyAdminConsoleTestingTabs = dynamic(() => import("./AdminConsoleTestingTabs"));
...
export default function AdminConsole({
  ...
  if (!renderTraceLoggedRef.current) {
    ...
    logAdminEvent("Admin console core render start", {
      forcedSchoolId,
      activeSchoolId,
      isManagedAuth,
  ...
  useEffect(() => {
    logAdminEvent("Admin console core first commit", {
      forcedSchoolId,
      activeSchoolId,
      isManagedAuth,
      managedRole: managedProfile?.role ?? null,
  ...
  return (
    <div className="admin-shell">
      ...
      <div className="admin-main">
        ...
        {activeTab === "model" || activeTab === "daily" ? (
          <LazyAdminConsoleTestingTabs {...testingTabProps} />
        ) : null}
        ...
        <LazyAdminConsoleDeferredFeatures
            resultContext={resultContext}
            sessionDetail={sessionDetail}
            renderSessionDetailView={renderSessionDetailView}
            dailyResultCategories={dailyResultCategories}
            modelResultCategories={modelResultCategories}
            modelResultsCategory={modelResultsCategory}
            selectedDailyCategory={selectedDailyCategory}
            selectedModelCategory={selectedModelCategory}
            setDailyResultsCategory={setDailyResultsCategory}
            setModelResultsCategory={setModelResultsCategory}
            runSearch={runSearch}
            exportDailyGoogleSheetsCsv={exportDailyGoogleSheetsCsv}
            exportModelGoogleSheetsCsv={exportModelGoogleSheetsCsv}
            openResultsImportStatus={openResultsImportStatus}
            dailyManualEntryMode={dailyManualEntryMode}
            setDailyManualEntryMode={setDailyManualEntryMode}
            clearDailyResultsForCategory={clearDailyResultsForCategory}
            resultsImportInputRef={resultsImportInputRef}
            resultsImportStatus={resultsImportStatus}
            getResultsImportTargetCategoryName={getResultsImportTargetCategoryName}
            importDailyResultsGoogleSheetsCsv={importDailyResultsGoogleSheetsCsv}
            importModelResultsGoogleSheetsCsv={importModelResultsGoogleSheetsCsv}
            quizMsg={quizMsg}
            dailyResultsMatrix={dailyResultsMatrix}
            modelResultsMatrix={modelResultsMatrix}
            dailyResultsSessionHeaderAverages={dailyResultsSessionHeaderAverages}
            modelResultsSessionHeaderAverages={modelResultsSessionHeaderAverages}
            dailyResultsSessionDetailAvailability={dailyResultsSessionDetailAvailability}
            modelResultsSessionDetailAvailability={modelResultsSessionDetailAvailability}
            openSessionDetailView={openSessionDetailView}
            isImportedSummaryAttempt={isImportedSummaryAttempt}
            openDailyManualEntryModal={openDailyManualEntryModal}
            getSessionEffectivePassRate={getSessionEffectivePassRate}
            expandedResultCells={expandedResultCells}
            setExpandedResultCells={setExpandedResultCells}
            ...
            loading={loading}
            msg={msg}
            applyTestFilter={applyTestFilter}
            filters={filters}
            ...
            previewReplacementMsg={previewReplacementMsg}
            isModelPreview={isModelPreview}
            previewSectionTitles={previewSectionTitles}
            previewSectionRefs={previewSectionRefs}
            previewSectionBreaks={previewSectionBreaks}
            renderPreviewQuestionCard={renderPreviewQuestionCard}
            previewDisplayQuestions={previewDisplayQuestions}
